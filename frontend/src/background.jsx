...
export default function DynamicBckg() {
    return (
        <div className='fixed inset-0 -z-10 flex items-center justify-center min-h-screen min-w-screen bg-linear-to-r 
  ...
  h-[30dvh] aspect-square    -translate-x-20 translate-y-20"></section>
  ...
  h-[30dvh] aspect-square -translate-x-20 -translate-y-20"></section>
   ...
   h-[30dvh] aspect-square flex items-center justify-center">
            </section>
